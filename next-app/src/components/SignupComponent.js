        ...
        <div className="row g-0">
          <div className="col-12 col-md-6">
            <Image
              ...
              src="./assets/img/create-an-account.svg"
              alt="Signin Visual"
              width={600}
              height={500}
              priority
            ...
            <div className="card-body">
                <div className='row'>
                    <div className="col-12">
                        <div className="text-center mb-4">
                            ...
                            <h1 className="h1-login-head">Create an account</h1>
                            <p className="mt-3 loginpara">Welcome to OkRated! Please enter your details.</p>
                        </div>
                    </div>
              ...
              <div className="text-center mt-5">
                <p className="f-size-14 color-dark-gray">
                  ...
                  <Link href="/login" className="text-decoration-none">Login in</Link>
                </p>
              </div>
